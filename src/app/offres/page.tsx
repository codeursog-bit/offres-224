...
const SECTEURS = ["Pétrole & Énergie","BTP","Informatique","Santé","Finance","Transport","Enseignement","Agriculture","Commerce","Télécoms"];
const EXPERIENCES = [
...
export default function OffresPage() {
  ...
  const resetFilters = () => { setQ(""); setVille(""); setContrats([]); setSecteurs([]); setExperience(""); setPage(1); };
            ...
            <div className="flex-1 min-w-0">
              ...
              {loading ? (
                ...
                <div className="text-center py-20">
                  <div className="text-5xl mb-4"><Icon name="search" className="w-5 h-5 text-gray-400" /></div>
